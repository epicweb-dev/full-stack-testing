...
<callout-info>
	NOTE: In the near future, React Testing Library will have a completely async
	API
	([#1214](https://github.com/testing-library/react-testing-library/pull/1214)).
	...
	`await` to our `render` and `act` calls.
</callout-info>
