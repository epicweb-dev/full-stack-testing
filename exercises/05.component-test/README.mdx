...
and they're really nice to use. Unfortunately they kind of mess up the types
when using vitest, so we'll not be using them in this workshop. Hopefully the
maintainers [fix this](https://github.com/testing-library/jest-dom/pull/472)
eventually and we can start using the nicer assertions.
