...
<EpicVideo url="https://www.epicweb.dev/workshops/web-application-testing/component-testing/error-list-component-with-react-testing-library/solution" />

👨‍💼 Super! We've got our first UI test. While we already have a way to test some
...
🦉 One of the cool things about these lower-level tests is we get to measure how
...
`app/components/forms.tsx`. Yikes, that's a lot of red 😅
...
🧝‍♂️ The rest of the tests will be pretty similar to what you just did, so I'm
